...
router.get('/airRailBusCharges/:parentTourBillId',verify, (request, response) => {
    ...
    response.render('airRailBusCharges',{objUser, parentTourBillId : parentTourBillId});
});
...
router.get('/conveyanceCharges/:parentTourBillId',verify, (request, response) => {
    ...
    response.render('tourBillConveyanceCharges',{objUser, parentTourBillId :parentTourBillId});
});
...
router.get('/boardingLodgingCharges/:parentTourBillId', verify, (request, response) => {
    ...
    .then((queryResult)=>{
       // console.log('querryResuklt '+JSON.stringify(queryResult.rows));
        ...
        console.log(city[0]);
        response.render('boardingLodgingCharges',{objUser,city, parentTourBillId :parentTourBillId});
...
router.get('/telephoneFood/:parentTourBillId',verify, (request, response) => {
    ...
    response.render('telephoneFoodCharges',{objUser, parentTourBillId : parentTourBillId});
});
...
router.get('/miscellenousCharges/:parentTourBillId', verify, (request, response) => {
    ...
    response.render('miscellenousCharges',{objUser, parentTourBillId : parentTourBillId});
});
